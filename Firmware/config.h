...
#define SAFETY_DOOR_SPINDLE_DELAY 2.5 // Float (seconds)
...
#define MIN_FEED_RATE_OVERRIDE           5 // Percent of programmed feed rate (1-100). Usually 50% or 1%
...
#define DWELL_TIME_STEP 35 // Integer (1-255) (milliseconds)
